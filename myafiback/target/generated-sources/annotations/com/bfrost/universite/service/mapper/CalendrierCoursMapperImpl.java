...
public class CalendrierCoursMapperImpl implements CalendrierCoursMapper {
    ...
    public CalendrierCours toEntity(CalendrierCoursDTO dto) {
        ...
        calendrierCours.setLien( dto.getLien() );
        calendrierCours.setDateDebut( dto.getDateDebut() );
        calendrierCours.setDateFin( dto.getDateFin() );
        calendrierCours.setMatiereUser( matiereUserDTOToMatiereUser( dto.getMatiereUser() ) );
        calendrierCours.setSalle( salleDTOToSalle( dto.getSalle() ) );
    ...
    public CalendrierCoursDTO toDto(CalendrierCours entity) {
        ...
        calendrierCoursDTO.setLien( entity.getLien() );
        ...
        calendrierCoursDTO.setMatiereUser( matiereUserToMatiereUserDTO( entity.getMatiereUser() ) );
