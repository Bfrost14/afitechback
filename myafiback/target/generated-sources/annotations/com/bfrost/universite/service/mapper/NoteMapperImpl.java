...
public class NoteMapperImpl implements NoteMapper {
    ...
    public NoteDTO toDto(Note s) {
        ...
        noteDTO.setUser( toDtoUserId( s.getUser() ) );
        noteDTO.setMatiere( toDtoMatiereId( s.getMatiere() ) );
        noteDTO.setSemestre( toDtoSemestreId( s.getSemestre() ) );
        noteDTO.setId( s.getId() );
        noteDTO.setValeur( s.getValeur() );
    ...
    @Override
    public SemestreDTO toDtoSemestreId(Semestre semestre) {
        if ( semestre == null ) {
            return null;
        }
