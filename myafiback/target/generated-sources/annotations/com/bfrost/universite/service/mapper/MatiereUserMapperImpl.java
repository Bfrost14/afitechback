...
public class MatiereUserMapperImpl implements MatiereUserMapper {
    ...
    @Override
    public MatiereUserDTO toDto(MatiereUser s) {
        if ( s == null ) {
            return null;
        }
        ...
        matiereUserDTO.setUser( toDtoUserId( s.getUser() ) );
        matiereUserDTO.setMatiere( toDtoMatiereId( s.getMatiere() ) );
        matiereUserDTO.setFiliere( toDtoFiliereId( s.getFiliere() ) );
        matiereUserDTO.setId( s.getId() );
        matiereUserDTO.setAnneeScolaire( s.getAnneeScolaire() );
    ...
    @Override
    public MatiereDTO toDtoMatiereId(Matiere matiere) {
        if ( matiere == null ) {
            return null;
        }
