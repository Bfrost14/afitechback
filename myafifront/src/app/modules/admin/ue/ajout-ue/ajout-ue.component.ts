...
@Component({
    selector: 'app-ajout-ue',
    templateUrl: './ajout-ue.component.html',
    styleUrls: ['./ajout-ue.component.scss'],
})
export class AjoutUeComponent implements OnInit {
    ...
    // ++++++++++++++++++++++++++++++++++++ mat-select infinit scroll categorie ue ++++++++++++++++++++++++++++++++++
    ...
    enregistrer() {
        //  console.log("ue form >>>>>>>>>>>>>>>>>>>>>>>>>>>>",this.form.value)
        ...
        this._ueService.create(this.form.value).subscribe((data) => {
            console.log(
                'saved ue  >>>>>>>>>>>>>>>>>>>>>>>>>>>>',
                data.body
            );
            this.add.emit(false);
            this._alertToastService.toastSuccess('Réussi', 'Ajout ue');
        });
    }

    modifier() {

        this._ueService.update(this.form.value).subscribe((data) => {
            console.log(
                'updated ue  >>>>>>>>>>>>>>>>>>>>>>>>>>>>',
                data.body
            );
    ...
    annuler() {
        console.log('@@@@@@@@@@ annuler ajouter ue @@@@@@@@@@@@@');
        this.add.emit(false);
