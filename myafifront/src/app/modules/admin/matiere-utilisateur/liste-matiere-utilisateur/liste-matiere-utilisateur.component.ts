 ...
 */
@Component({
    selector: 'app-liste-matiere-utilisateur',
    styleUrls: ['./liste-matiere-utilisateur.component.scss'],
    templateUrl: './liste-matiere-utilisateur.component.html',
    animations: [
...
export class ListeMatiereUtilisateurComponent implements OnInit, AfterViewInit {
    ...
    columnsToDisplay = ['anneeScolaire', 'matiere', 'professeur', 'filiere', 'semestre'];
    displayedColumn: string[] = ['anneeScolaire', 'matiere', 'professeur', 'filiere', 'semestre'];
    displayedColumns: string[] = ['anneeScolaire', 'matiere', 'professeur', 'filiere', 'semestre'];
    ...
    setDataSourceEdit(matiere: NewMatiereUtilisateur) {
        console.log('>>>>>>>>>>>>>>>.. data set >>>>>>>>>>>>>>>>>>', matiere);
        if (this.add) {
            this.matiereUtilisateurIdEdit = null
            this.selectMatiereUtilisateurEdit = null
            this.add = false;
            this.data = [...this.dataSource];
        } else {
            this.matiereUtilisateurIdEdit = matiere.id
            this.selectMatiereUtilisateurEdit = matiere
            this.add = true;
            this.data = [matiere];
        }
    }
