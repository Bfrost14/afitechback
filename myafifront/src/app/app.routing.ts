        ...
        children: [
            ...
            // Dashboards
            {
                path: 'admin', children: [
                    ...
                    { path: 'annee', loadChildren: () => import('app/modules/admin/annee-scolaire/annee-scolaire.module').then(m => m.AnneeScolaireModule) },
                    ...
                    { path: 'etudiant', loadChildren: () => import('app/modules/admin/etudiant/etudiant.module').then(m => m.EtudiantModule) },
                    { path: 'affectation', loadChildren: () => import('app/modules/admin/matiere-utilisateur/matiere-utilisateur.module').then(m => m.MatiereUtilisateurModule) },

                ]
            },

            {
                path: 'gestionprofesseur', children: [
                    { path: 'pointage', loadChildren: () => import('app/modules/admin/pointage-professeur/pointage-professeur.module').then(m => m.PointageProfesseurModule) },
